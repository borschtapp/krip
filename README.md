...
Contributions are welcome! Whether it's adding a new custom scraper or improving the core logic.
...
We can also assume that it works with any website that implemented Recipe schema, you can find a list of popular websites here <https://trends.builtwith.com/websitelist/Recipe-Schema>
